...
export default function FeatureSection({ data }: FeatureSectionProps) {
  ...
  return (
    <section className="bg-[#F4F3EC] py-20 md:py-32 overflow-hidden">
      <LayoutWrapper>
        <div className="flex flex-collg:flex-row gap-12 lg:gap-24 items-start">
          ...
          <div className="flex-1 flex flex-col gap-12 lg:gap-16">
                          ...
                          return (
                            <span
                              ...
                              className={cn(
                                ...
                                isBold
                                  ? "text-2xl md:text-3xl lg:text-4xl font-bold text-[#0F0F0F] tracking-tight"
                                  : "text-xl md:text-2xl font-medium text-[#0F0F0F]/40 tracking-tight",
                              )}
                            >
                              {textNode.value}
                            </span>
            ...
            <div className="flex flex-col gap-4 mt-auto pt-8">
              {subHeading && (
                <h3 className="text-xl md:text-2xl font-medium text-[#0F0F0F]">
                  {subHeading}
                </h3>
              )}
              {description && (
                <p className="text-base md:text-lg text-[#0F0F0F]/70 leading-relaxed max-w-xl">
                  {description}
                </p>
              )}
            </div>
          ...
          <div className="flex-1 w-full flex justify-end">
            <div className="relative w-full max-w-[600px] aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-[32px] overflow-hidden border border-[#0F0F0F]/10 shadow-2xl bg-white">
              {imageUrl && (
